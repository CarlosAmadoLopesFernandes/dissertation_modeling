...
import pickle
pickle.dump(classifier, open('../../exported_models/5_parks_1hour_scenario1/naive_bayes.pkl', 'wb'))
pickle.dump(list(dataset.columns)[:-1], open('../../exported_models/5_parks_1hour_scenario1/model_columns.pkl', 'wb'))
