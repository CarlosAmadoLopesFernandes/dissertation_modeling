...
key = configs.config['google']['distances_key']
...
@app.route('/5parks/scenario1', methods=['POST'])
def predict1():
    try:
        ...
        if response:
            ...
            for park in parks_data:
                columns = pickle.load(open('models/5_parks_1hour_scenario1/model_columns.pkl', 'rb'))
                ## GET PLACES OF PARK
...
def predict2():
    ...
    try:
        ...
        model = pickle.load(open('models/10_parks_1_hour_scenario1/naive_bayes.pkl', 'rb'))
